...
insert into product(product_condition, description, name, status, price, user_id, created_at)
    values ('95% new', 'A mountain bike that I bought from CostCo last week, only used for a day', 'Mountain bike', 'LISTED', 200.00, 1, CURRENT_TIMESTAMP());
insert into product_image(path, product_id)
    values ('6fadada5-87c2-43d3-8002-fe2596b18d43.jpg', 1);

insert into product(product_condition, description, name, status, price, user_id, created_at)
    values ('90% new', 'Only wear once. With tags and receipt ', 'Snow Jacket', 'LISTED', 99.00, 1, CURRENT_TIMESTAMP());
insert into product_image(path, product_id)
    values ('05f36f60-4edf-42cb-81c9-e1d550dcfc31.jpg', 2);

insert into product(product_condition, description, name, status, price, user_id, created_at)
    values ('100% new', 'Does not fit my face, never wore', 'Oakley Goggle', 'LISTED', 120.00, 1, CURRENT_TIMESTAMP());
insert into product_image(path, product_id)
    values ('675991b5-2325-4d19-a144-560100aaf60d.jpg', 3);

insert into product(product_condition, description, name, status, price, user_id, created_at)
    values ('Like new', 'Upgraded to a better bindings, selling it for cheap', 'Burton Bindings', 'LISTED', 50.00, 1, CURRENT_TIMESTAMP());
insert into product_image(path, product_id)
    values ('05595596-dd2e-44a0-a5bc-980bfac06d52.jpg', 4);

insert into product(product_condition, description, name, status, price, user_id, created_at)
    values ('OK', 'Old helmet I purchased from 5 years ago', 'Oakley Helmet', 'LISTED', 10.00, 3, CURRENT_TIMESTAMP());
insert into product_image(path, product_id)
    values ('fad65619-bba9-4ebc-ab48-1593ccd44220.jpg', 5);

insert into product(product_condition, description, name, status, price, user_id, created_at)
    values ('85%', 'Old snow gloves of my son bought 2 years ago', 'Ski Gloves', 'UNLISTED', 10.00, 3, CURRENT_TIMESTAMP());
insert into product_image(path, product_id)
