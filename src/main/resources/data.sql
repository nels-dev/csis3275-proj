...
insert into product(id, product_condition, description, name, status, price) values (1, '95% new', 'A mountain bike that I bought from CostCo last week, only used for a day', 'Mountain bike', 'LISTED', 200.00);
